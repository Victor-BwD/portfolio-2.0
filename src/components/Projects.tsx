...
export const projectsInfo = [
  {
    ...
    description: 'Um jogo feito com o propósito de estudar a Unity.',
    descriptionEnglish: 'A game made with study purpose.',
    descriptionForProjectView: 'Comecei esse projeto por um curso de Unity que comprei, porém gostei tanto do resultado que decidi seguir com o jogo. O jogo é inspirado em Castlevania e Dark Souls, ainda vou colocar pontos como souls para up, loja e um chefe final.',
    descriptionForProjectViewEnglish: 'I started this project from a Unity course I bought, but I liked the result so much that I decided to continue with the game. The game is inspired by Castlevania and Dark Souls. I still plan to add features like soul points for leveling up, a shop, and a final boss.',
    source: '/project/1',
