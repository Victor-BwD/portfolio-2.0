...
export const projectsInfo = [
  ...
  },
  {
    ...
    descriptionForProjectView: 'Projeto feito para aprendizado de React. O site é responsivo para todos os dispositivos e estilizado com ChakraUI. Tive a ideia de fazer um site de um jogo que gosto muito, Baldurs Gate 3, misturando algumas referências e gosto pessoais.',
    descriptionForProjectViewEnglish: 'Project made for learning React. The website is responsive for all devices and styled with ChakraUI. I had the idea of creating a website for a game I really like, Baldurs Gate 3, mixing some references and personal tastes.',
    source: '/project/2',
